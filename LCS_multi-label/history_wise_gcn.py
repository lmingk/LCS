...
from optimizers import package_mxl_orders,variance_reduced_step
...
def vr_gcn(args, device):
    ...
    if args.dataset == 'pubmed': args.stop1 = 5
    ...
    for phase in range(100):
        ...
        adjs, input_nodes = vrgcn_sampler_.target_nodes_batch1(adj_lap,nodes)
        ...
        vrgcn_sampler_.scale_growing(adj_lap,train_nodes,labels,target_nodes,args.beta,args)
        ...
        while True:
            ...
            cur_train_loss= variance_reduced_step(susage, optimizer, features,labs, train_data,device, wrapper,order_list)
            t1 = time.time()
            run_time = t1 - t0
